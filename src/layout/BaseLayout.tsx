...
const BaseLayout = () => {
  return (
    <main className='flex flex-col-reverse xl:flex-row xl:justify-around'>
       ...
       <div>
          <figure>
              <div className='xl:hidden my-7 mx-5'><Nav/></div>
              <img src={hero} alt='' className='xl:hidden w-full' />
              <img src={heroDesk} alt=''  className=' hidden xl:block w-[800px]  h-min-[100vh]  ' />
          </figure>
       </div>
    </main>
  )
